export const environment = {
  production: true,
  requireULEmail: false, // require UL e-mail addresses on signup
  testing: false,
  default_template_id: 'expedited', // default ethics template ID
  ...
  api_base: 'http://localhost:8081', // the URL and PORT of the backend API
  ...
  confirmManualAnswerOnce: false // when choosing to manually answer a question requiring input and then request input, set this to true to confirm only once, or false to confirm each time
};
